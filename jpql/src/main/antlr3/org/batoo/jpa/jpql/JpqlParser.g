...
between_expression options { backtrack=true; } :
    between_expression_argument (NOT)? BETWEEN between_expression_argument AND between_expression_argument
        -> ^(BETWEEN between_expression_argument between_expression_argument between_expression_argument (NOT)?);

between_expression_argument options { backtrack=true; } :
