...
public class Person$Prototype extends Person implements EnhancedInstance {
	...
	public Person$Prototype(Class<?> type, SessionImpl session, SingularAssociationMapping<?, ?> mapping, Object mappingId, Object id, boolean initialized) {
		super();
