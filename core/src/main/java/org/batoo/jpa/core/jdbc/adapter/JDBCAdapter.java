...
public abstract class JDBCAdapter extends AbstractJDBCAdapter {
	 ...
	 * @author hceylan
	 */
	public JDBCAdapter() throws MappingException {
		super();
	...
	/**
	 * Creates the Column Definition DDL For the column.
	 * 
	 * @param columnDefinition
	 *            the column definition to create the DDL from
	 * @return the Column Definition DDL For the column
	 * 
	 * @since $version
	 * @author hceylan
	 */
	 ...
	 * @author hceylan
	 */
	public String createCreateTableStatement(Table table, List<String> ddlColumns) {
