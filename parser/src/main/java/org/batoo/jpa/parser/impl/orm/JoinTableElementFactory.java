...
/**
 * Element factory for <code>join-table</code> elements.
 * 
 * @author hceylan
 * @since $version
 */
public class JoinTableElementFactory extends TableElementFactory implements JoinTableMetadata {
	 ...
	 * @author hceylan
	 */
	public JoinTableElementFactory(ParentElementFactory parent, Map<String, String> attributes) {
		super(parent, attributes, //
			ElementFactoryConstants.ELEMENT_UNIQUE_CONSTRAINT, //
			ElementFactoryConstants.ELEMENT_JOIN_COLUMN,//
			ElementFactoryConstants.ELEMENT_INVERSE_JOIN_COLUMN);
	}
	...
	protected void handleChild(ElementFactory child) {
		...
		if (child instanceof InverseJoinColumnElementFactory) {
