 ...
 * @since $version
 */
public class EmbeddedIdAttributeElementFactory extends SingularAttributeElementFactory implements EmbeddedIdAttributeMetadata {
	 ...
	 * @author hceylan
	 */
	public EmbeddedIdAttributeElementFactory(ParentElementFactory parent, Map<String, String> attributes) {
		super(parent, attributes, ElementFactoryConstants.ELEMENT_ATTRIBUTE_OVERRIDE);
	}
