...
public class AttributesMetadataImpl implements AttributesMetadata {
	...
	private final TransientsParser transients;
	private final IdsParser ids;
	private final EmbeddedIdsParser embeddedIds;
	private final BasicsParser basics;
	private final VersionsParser versions;
	private final OneToOnesParser oneToOnes;
	private final OneToManiesParser oneToManies;
	private final ManyToOnesParser manyToOnes;
	private final ManyToManiesParser manyToManies;
	...
	private final EmbeddedsParser embeddeds;
	...
	public AttributesMetadataImpl(EntityMetadataImpl parent, AttributesMetadata ormMetadata) {
		...
		// transients
		this.transients = new TransientsParser(this, this.memberMap, ormMetadata != null ? ormMetadata.getTransients() : null);

		// id and version stuff
		this.ids = new IdsParser(this, this.memberMap, ormMetadata != null ? ormMetadata.getIds() : null);
		this.embeddedIds = new EmbeddedIdsParser(this, this.memberMap, ormMetadata != null ? ormMetadata.getEmbeddedIds() : null);
		this.versions = new VersionsParser(this, this.memberMap, ormMetadata != null ? ormMetadata.getVersions() : null);

		// embeddeds
		this.embeddeds = new EmbeddedsParser(this, this.memberMap, ormMetadata != null ? ormMetadata.getEmbeddeds() : null);

		// associations
		this.oneToOnes = new OneToOnesParser(this, this.memberMap, ormMetadata != null ? ormMetadata.getOneToOnes() : null);
		this.oneToManies = new OneToManiesParser(this, this.memberMap, ormMetadata != null ? ormMetadata.getOneToManies() : null);
		this.manyToOnes = new ManyToOnesParser(this, this.memberMap, ormMetadata != null ? ormMetadata.getManyToOnes() : null);
		this.manyToManies = new ManyToManiesParser(this, this.memberMap, ormMetadata != null ? ormMetadata.getManyToManies() : null);

		// basics is the last
		this.basics = new BasicsParser(this, this.memberMap, ormMetadata != null ? ormMetadata.getBasics() : null);
	}
	...
	public List<BasicAttributeMetadata> getBasics() {
		return this.basics.getAttributes();
	}
	...
	public List<EmbeddedIdAttributeMetadata> getEmbeddedIds() {
		return this.embeddedIds.getAttributes();
	}
	...
	public List<EmbeddedAttributeMetadata> getEmbeddeds() {
		return this.embeddeds.getAttributes();
	}
	...
	public List<ManyToManyAttributeMetadata> getManyToManies() {
		return this.manyToManies.getAttributes();
	}
	...
	public List<ManyToOneAttributeMetadata> getManyToOnes() {
		return this.manyToOnes.getAttributes();
	}
	...
	public List<OneToManyAttributeMetadata> getOneToManies() {
		return this.oneToManies.getAttributes();
	}
	...
	public List<OneToOneAttributeMetadata> getOneToOnes() {
		return this.oneToOnes.getAttributes();
	}
	...
	public List<TransientAttributeMetadata> getTransients() {
		return this.transients.getAttributes();
	}
	...
	public List<VersionAttributeMetadata> getVersions() {
		return this.versions.getAttributes();
	}
