 ...
 * @since $version
 */
public abstract class SecondaryTableElementFactory extends ParentElementFactory implements TableMetadata {
	 ...
	 * @author hceylan
	 */
	public SecondaryTableElementFactory(ParentElementFactory parent, Map<String, String> attributes, String... expectedChildElements) {
