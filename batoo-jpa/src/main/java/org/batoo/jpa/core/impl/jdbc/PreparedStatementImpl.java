...
public class PreparedStatementImpl implements PreparedStatement {
	...
	private static final BLogger LOG = BLoggerFactory.getLogger(PreparedStatementImpl.class);
	 ...
	 * @param pool
	 *            the pool of prepared statements
	 * 
	 * @since $version
	 * @author hceylan
	 */
	public PreparedStatementImpl(ConnectionImpl connection, String sql, PreparedStatement statement, GenericKeyedPool<String, PreparedStatementImpl> pool) {
		...
		this.statementNo = PreparedStatementImpl.no.incrementAndGet();
	...
	/* package */void close0() throws SQLException {
		...
		PreparedStatementImpl.LOG.trace("{0}:{1}:{2} close()", this.connection.connNo, this.statementNo, executeNo);
	...
	public ResultSet executeQuery() throws SQLException {
		...
		PreparedStatementImpl.LOG.debug("{0}:{1}:{2} executeQuery(){3}", this.connection.connNo, this.statementNo, executeNo,
			PreparedStatementImpl.LOG.lazyBoxed(this.sql, this.parameters));
	...
	public int executeUpdate() throws SQLException {
		...
		PreparedStatementImpl.LOG.debug("{0}:{1}:{2} executeUpdate(){3}", this.connection.connNo, this.statementNo, executeNo,
			PreparedStatementImpl.LOG.lazyBoxed(this.sql, this.parameters));
