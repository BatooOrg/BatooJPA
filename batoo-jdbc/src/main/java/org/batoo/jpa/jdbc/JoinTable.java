...
public class JoinTable extends AbstractTable implements JoinableTable {
	 ...
	 * @since 2.0.0
	 */
	public JoinTable(JdbcAdaptor jdbcAdaptor, EntityTypeDescriptor entity, AssociationMapping<?, ?, ?> mapping, JoinTableMetadata metadata) {
		super(metadata);
	 ...
	 * @since 2.0.0
	 */
	public void link(EntityTypeDescriptor source, EntityTypeDescriptor destination) {
