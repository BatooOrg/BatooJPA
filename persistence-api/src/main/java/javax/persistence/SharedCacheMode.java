...
/**
 * Specifies how the provider must use a second-level cache for the persistence unit. Corresponds to the value of the
 * <code>persistence.xml</code> <code>shared-cache-mode</code> element, and returned as the result of
