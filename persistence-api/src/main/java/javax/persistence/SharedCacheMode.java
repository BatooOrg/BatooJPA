 ...
 * persistence unit. Corresponds to the value of the <code>persistence.xml</code> <code>shared-cache-mode</code> element, and returned as
 * the result of {@link javax.persistence.spi.PersistenceUnitInfo#getSharedCacheMode()}.
 * 
...
public enum SharedCacheMode {
	...
	/**
	 * Caching is enabled for all entities except those for which <code>Cacheable(false) is specified.  Entities for which
