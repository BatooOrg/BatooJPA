 ...
 * 
 * <p>
 * When the application has finished using the entity manager factory, and/or at application shutdown, the application should close the
 * entity manager factory. Once an <code>EntityManagerFactory</code> has been closed, all its entity managers are considered to be in the
 * closed state.
 * 
...
public interface EntityManagerFactory {
	 ...
	 * for <code>isOpen</code>, which will return false. Once an <code>EntityManagerFactory</code> has been closed, all its
