 ...
 * 
 * <p>
 * It is invoked by the container in Java EE environments and by the {@link javax.persistence.Persistence} class in Java SE environments to
...
public interface PersistenceProvider {
	 ...
	 *            properties not specified in the <code>persistence.xml</code> (and may be null if no properties are specified).
	 * 
