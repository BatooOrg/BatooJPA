...
public interface Path<X> extends Expression<X> {
	 ...
	 * 
	 * <p>
	 * Note: Applications using the string-based API may need to specify the type resulting from the <code>get</code> operation in order to
	 * avoid the use of <code>Path</code> variables.
	 * 
	 * <pre>
	 *     For example:
	 * 
