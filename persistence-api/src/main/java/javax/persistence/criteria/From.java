...
public interface From<Z, X> extends Path<X>, FetchParent<Z, X> {
	 ...
	 * correlation (use of a <code>Subquery</code> <code>correlate</code> method).
	 * 
	...
	/**
	 * Returns the parent <code>From</code> object from which the correlated <code>From</code> object has been obtained through correlation
	 * (use
