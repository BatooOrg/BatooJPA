...
/**
 * Defines the values of the <code>javax.persistence.lock.scope</code> property for pessimistic locking. This property may be passed as
 * an argument to the methods of the {@link EntityManager}, {@link Query}, and {@link TypedQuery} interfaces that
 * allow lock modes to be specified or used with the {@link NamedQuery} annotation.
 * 
...
public enum PessimisticLockScope {
	...
	/**
	 * In addition to the behavior for <code>PessimisticLockScope.NORMAL</code>, element collections
	 * and relationships owned by the entity that are contained in
	 * join tables will be locked if the <code>javax.persistence.lock.scope</code> property is specified
